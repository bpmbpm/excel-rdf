...
ver3: вкладка «TriG → Excel» после загрузки простого примера `trig-simple.trig`
(перечень из 9 листов книги, включая листы МегаТипов `ex:Product`, `ex:Customer`,
`ex:Order`, общий лист «TriG» и реестр «МегаТипы»):

![ver3 TriG простой пример](screenshots/ver3-trig-simple.png)

> Примечание. Скриншоты `trig-to-excel.png` и `excel-book.png` сделаны на раскладке ver2
> (листы по графам) и иллюстрируют общий вид интерфейса и книги. Скриншот
> `ver3-trig-simple.png` сделан на актуальной раскладке ver3 (листы по МегаТипам со
> столбцом «TriG»).
